locals {
  ...
  # Fixture-only defect: a second top-level assignment further down the
  # file. A real site.hcl must never have this -- SetPausedFlag/
  # ReadPausedFlag must refuse to guess which one is authoritative.
  paused = true
