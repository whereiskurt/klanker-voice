...
Spec §4/§11/§23/§24/§25 provide the locked frame (subaccount shape, DID routing, codec, security controls, mint-path reuse). D-01..D-07 are the gray areas decided in this discussion.
...
*Context gathered: 2026-07-12 — `/gsd-discuss-phase` (7 gray areas decided: D-01 pull cloud edge forward as "working secure edge" / D-02 private /tel mint endpoint / D-03 kv voipms + runbook / D-04 full SSM now / D-05 caller-ID baseline + gate upgrade + seed kph-tier / D-06 manual cellular proof + CI unit tests) atop the telephony spec §4/§11/§19-D/§23/§24/§25, grounded against the bypass /join mint machinery + the Phase 9/10/11 telephony stack*
